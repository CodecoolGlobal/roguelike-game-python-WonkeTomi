...
PILL = "You have just found a wierd little pill and eat is. Because why not."
...
POSSIBILITIES = {
    ...
    ':game_die:': ['You rolled one. The dice turn into bomb and blown up.', 'You rolled 20. The dice turn into a magical forg who heals you.', ROLL_DIE],
    ':onion:': ["The onion wasn't a normal onion. It was poisionus.", 'Your belly is full.', ONION],
    ':pill:': ['At first everything seems normal. After some minutes you puke yourself.', 'It was a C-vitamin pill. Good for you.', PILL],
    ':soft_ice_cream:': ["It wasn't choclate. It was shit...", "It was fine.", ICE_CREAM],
    ':middle_finger:': ["He just kick your ass because why not.", "You kick his ass and took his helt potion.", MIDDLE_FINGER],
